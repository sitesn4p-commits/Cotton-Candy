...
export function HomePage() {
  ...
  const specialities = ['Birthday Decorations', 'Wedding Styling', 'Baby Shower Styling', 'Bridal Showers', 'Christenings', 'Engagement Parties', 'Corporate Events', 'Balloon Garlands', 'All Party Items Hire']
  ...
  return <>
    <section className="hero hero-landscape"><div className="hero-glow hero-glow-one" /><div className="hero-glow hero-glow-two" /><HeroBalloons /><div className="hero-content container"><p className="eyebrow">Melbourne event styling & hire</p><HeroTypedHeading onPointerDown={bloomHeroHeading} /><p className="hero-copy">Thoughtful, luxe styling for the moments that deserve a little magic.</p><div className="hero-actions"><Link className="button button-dark" to="/services">Explore our services <span>↗</span></Link><Link className="text-link" to="/gallery/images">See the magic <span>→</span></Link></div></div><div className="hero-photo hero-photo-main"><img src={heroMain} alt="Cotton Candy event styling" /></div><div className="hero-photo hero-photo-small"><img src={heroSmall} alt="Cotton Candy event detail" /></div><div className="hero-note">Celebrations, but make them<br /><strong>extra special</strong> <span>♡</span></div></section>
    ...
    <section className="trust-bar container"><p>Styling the sweetest celebrations across Melbourne</p><div><span>Weddings</span><i /><span>Birthdays</span><i /><span>Baby showers</span><i /><span>Corporate events</span></div></section>
    <section className="intro-section container section-grid home-intro-section"><div className="intro-images"><img className="intro-main" src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&w=850&q=85" alt="Beautifully decorated event table" /><img className="intro-small" src="https://images.unsplash.com/photo-1507504031003-b417219a0fde?auto=format&fit=crop&w=450&q=85" alt="Pastel event details" /></div><div className="intro-copy"><p className="eyebrow">Luxury Event Styling & Balloon Decorations in Melbourne</p><h2>Creating unforgettable celebrations <em>across Melbourne.</em></h2><p>Create unforgettable celebrations with premium balloon garlands, custom backdrops, welcome signs and event styling for birthdays, baby showers, weddings and corporate events across Melbourne.</p><Link className="text-link" to="/about">Get to know us <span>→</span></Link></div></section>
    ...
    <section className="featured-section container"><div className="featured-photo"><img src="https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=1200&q=85" alt="Wedding reception with flowers" /><div className="photo-label">Designed with love<br /><em>in every detail</em></div></div><div className="featured-copy"><p className="eyebrow">Something sweet</p><h2>See our current <em>celebration offers.</em></h2><Link className="text-link" to="/promotions">View promotions <span>→</span></Link></div></section>
    ...
    <section className="home-service-summary"><div className="container"><p>Luxury Event Styling <span>•</span> Balloon Decorations <span>•</span> Backdrop Hire <span>•</span> Party Items Hire</p><small>Servicing Melbourne and surrounding suburbs with premium event styling for birthdays, weddings, baby showers and corporate events.</small></div></section>
  </>
}
...
export function UpdatedAboutPage() {
  return <>
    <PageHero eyebrow="Our story" className="page-hero-about" title={<>We believe every<br />celebration deserves<br /><em>a little magic.</em></>} />
    <section className="about-story container section-grid"><div className="about-copy"><p className="eyebrow">About Cotton Candy Event Deco</p><h2>Luxury in the details. <em>Joy in every moment.</em></h2><p>At Cotton Candy Event Deco, we believe every celebration deserves to be unforgettable.</p><p>Based in Melbourne, we specialise in luxury event styling, balloon decorations, premium backdrop hire and custom event décor for every occasion.</p><p>From intimate family celebrations to large corporate events, we create beautiful, stress-free setups tailored to your style, colours and budget.</p><p>Our goal is simple — to create an event your guests will remember long after the celebration ends.</p></div><div className="about-image-stack"><img className="about-image-large" src="https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&w=800&q=85" alt="Elegant wedding styling" /><div className="established-badge">Made with<br /><em>love</em><br />in Melbourne</div></div></section>
    <section className="values-section pink-wash"><div className="container"><div className="section-heading"><div><p className="eyebrow">What matters to us</p><h2>The <em>Cotton Candy</em> difference.</h2></div></div><div className="values-grid"><Value number="01" title="Intentional styling" copy="Every colour, curve and tiny detail is chosen to tell your story beautifully." /><Value number="02" title="Made for you" copy="Your celebration is one of a kind. Your décor should feel exactly the same." /><Value number="03" title="Stress-free magic" copy="We make the whole process feel simple, seamless and a little bit fun." /></div></div></section>
    <section className="finishing-section container section-grid"><div className="finishing-photo"><img src="https://images.unsplash.com/photo-1507504031003-b417219a0fde?auto=format&fit=crop&w=850&q=85" alt="Pastel flower arrangement" /></div><div className="finishing-copy"><p className="eyebrow">The finishing touches</p><h2>It’s the little things that make a <em>big impact.</em></h2><p>From welcome signs to bespoke flower arrangements, our team pays attention to every element of your event décor. We offer customisable packages, ensuring each event is as unique as our clients.</p><Link className="button button-dark" to="/contact">Create something beautiful <span>↗</span></Link></div></section>
  </>
}
