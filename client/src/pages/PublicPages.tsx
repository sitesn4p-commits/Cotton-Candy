...
export function HomePage() {
  const [hero, setHero] = useState<Pick<HomeContent, 'heroMainUrl' | 'heroSmallUrl' | 'introMainUrl' | 'introSmallUrl'>>({ heroMainUrl: '', heroSmallUrl: '', introMainUrl: '', introSmallUrl: '' })
  ...
  const specialities = ['Birthday Decorations', 'Wedding Styling', 'Baby Shower Styling', 'Bridal Showers', 'Christenings', 'Engagement Parties', 'Gender Reveals', 'Bride to Be Parties', 'Corporate Events', 'Balloon Garlands', 'All Party Items Hire']
  ...
  return <>
    ...
    <section className="trust-bar home-service-ticker" aria-label="Cotton Candy Event Deco services"><p>Styling the sweetest celebrations across Melbourne</p><div className="home-service-ticker-track"><span>Birthday Decorations</span><i /><span>Wedding Styling</span><i /><span>Baby Shower Styling</span><i /><span>Bridal Showers</span><i /><span>Christenings</span><i /><span>Engagement Parties</span><i /><span>Gender Reveals</span><i /><span>Bride to Be Parties</span><i /><span>Corporate Events</span><i /><span>Balloon Garlands</span><i /><span>All Party Items Hire</span><i /><span>Birthday Decorations</span><i /><span>Wedding Styling</span><i /><span>Baby Shower Styling</span><i /><span>Bridal Showers</span><i /><span>Christenings</span><i /><span>Engagement Parties</span><i /><span>Gender Reveals</span><i /><span>Bride to Be Parties</span><i /><span>Corporate Events</span><i /><span>Balloon Garlands</span><i /><span>All Party Items Hire</span></div></section>
...
export function UpdatedAboutPage() {
  const [artwork, setArtwork] = useState<Pick<HomeContent, 'aboutHeroUrl' | 'aboutStoryUrl'>>({ aboutHeroUrl: '', aboutStoryUrl: '' })
