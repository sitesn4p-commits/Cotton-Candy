...
export function SiteLayout() {
  ...
  return <div className="app-root" onPointerDown={bloom}>
    ...
    <header className="site-header"><div className="container nav-wrap"><a className="header-phone" href="tel:+61492130377" aria-label="Call Cotton Candy Event Deco on 0492 130 377">0492 130 377</a><NavLink className="brand" to="/" onClick={closeMenu} aria-label="Cotton Candy home"><span className="brand-mark">C</span><span>Cotton<br /><em>Candy</em></span></NavLink><button className="mobile-menu-button" type="button" aria-label="Open navigation" aria-expanded={open} onClick={() => setOpen(true)}><span /><span /></button><nav className="site-nav site-nav-desktop" aria-label="Main navigation"><NavigationLinks closeMenu={closeMenu} /></nav></div></header>
