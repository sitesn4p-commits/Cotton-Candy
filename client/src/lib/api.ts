...
export type HomeContent = { _id: string; heroMainUrl: string; heroSmallUrl: string; heroSlides?: HeroSlide[]; introMainUrl: string; introSmallUrl: string; aboutHeroUrl: string; aboutStoryUrl: string; bookingsHeroUrl: string }
